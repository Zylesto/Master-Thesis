...
Despite varying recommendations on weighting between \ac{CVSS} and \ac{EPSS}, this work adopts a weighting factor of 2 for \ac{EPSS}. This choice deliberately emphasizes empirical exploit probability, aligning with recent studies highlighting \ac{EPSS}'s strength in predicting real-world exploitation \autocite{jacobs_exploit_2021, first_epss_2021}.
