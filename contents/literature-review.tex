...
\subsection{Common Vulnerabilities and
Exposures}
...
\begin{itemize}
    ...
    \item The FIRST.org \ac{EPSS} Database is employed to retrieve the \ac{EPSS} score corresponding to a specific \ac{CVE} identifier.
\end{itemize}
