...
The model integrates data from multiple sources to comprehensively evaluate vulnerabilities. Each vulnerability is referenced through a standardized \ac{CVE} identifier, facilitating consistent data retrieval. This identifier is supplemented by metrics from \ac{CVSS} and \ac{EPSS}, which provide insights into technical severity and exploitation likelihood, respectively. The primary data sources include the \ac{NVD}, \ac{OSV}, \ac{GAD}, and the \texttt{first.org} EPSS database.
